...
is ordered and first-match-wins — see [Refs](/docs/getting-started/refs) for
...
See [Environment and templates](/docs/configuration/environment-and-templates).
...
- [Workspaces and worktrees](/docs/getting-started/workspaces) — the
  consequences of the worktree model, and the sharp edges worth knowing.
- [Refs](/docs/getting-started/refs) — every ref form, in resolution order.
